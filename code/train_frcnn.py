...
def train_kitti():
    ...
    cfg.model_path = '/content/gdrive/My Drive/Code/model/kitti_frcnn_last.hdf5'
    #cfg.simple_label_file = 'kitti_simple_label.txt'
    cfg.simple_label_file = '/content/gdrive/My Drive/Code/FRCNN_input.txt'
    ...
    epoch_length = 100
#I think the epoch_length corresponds to the batch_size
